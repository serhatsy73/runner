...
(function (KS) {
  ...
  const INTRO = {
    multi: {
      ...
      text: 'Sürüklerken diğer mavi kulelerinin <strong>üstünden geç</strong>. Bıraktığında hepsi aynı hedefe saldırır. Ortadaki büyük kuleyi tek kuleyle alamazsın!',
    },
    yellow: {
  ...
  const LIST = [
    ...
    { boss: true, par: 90, ai: [R], tip: 'Boss: Kırmızı Kale!', towers: [   // 10: boss
    ...
    { par: 95, ai: [R], range: .45, intro: 'river', towers: [   // 13: nehir ve köprü
    ...
    { par: 85, ai: [R, Y], range: .42, towers: [   // 14: iki köprü, iki rakip
    ...
    { par: 50, ai: [R], range: .45, towers: [   // 15: nefes: göl
      t(.5, .88, P, 25), t(.5, .12, R, 14),
      t(.15, .5, N, 8), t(.85, .5, N, 8), t(.25, .28, N, 6), t(.75, .28, N, 6), t(.25, .72, N, 6), t(.75, .72, N, 6),
    ], obstacles: [lake(.5, .5, .14, .12)] },
    { par: 100, ai: [R, Y], range: .45, tip: 'Kırmızı ve sarı köprüde çarpışıyor', towers: [   // 16: nehir iki rakibi ayırır
      t(.5, .88, P, 22), t(.2, .12, R, 28), t(.8, .12, Y, 28),
      t(.2, .4, N, 8), t(.8, .4, N, 8), t(.25, .66, P, 10), t(.75, .66, N, 6), t(.5, .72, N, 12),
    ], obstacles: [river([[.5, -.05], [.47, .3], [.53, .55]], .07, [[.4854, .12]])] },
    { par: 95, ai: [R], range: .38, towers: [   // 17: taş labirent
      t(.5, .9, P, 20), t(.5, .1, R, 24),
      t(.5, .6, N, 12), t(.2, .8, N, 6), t(.8, .8, N, 6), t(.2, .55, N, 8), t(.8, .55, N, 8), t(.3, .3, N, 10), t(.7, .3, N, 10),
    ], obstacles: [rock(.5, .75), tree(.35, .45), tree(.65, .45), rock(.5, .4, .03), rock(.12, .68, .03), rock(.88, .68, .03)] },
    { par: 115, ai: [R], range: .45, towers: [   // 18: iki göl
    ...
    { par: 80, ai: [R, Y], range: .42, persona: { 3: 'aggressive' }, tip: 'İkisi de saldırgan!', towers: [   // 19: nehir + kayalar + iki rakip
      t(.3, .88, P, 21), t(.7, .88, P, 21), t(.2, .1, R, 30), t(.8, .1, Y, 30),
    ...
    { boss: true, par: 140, ai: [R], range: .42, tip: 'Boss: Nehir Kalesi!', towers: [   // 20: boss
      t(.5, .9, P, 25), t(.2, .78, P, 12), t(.8, .78, P, 12), t(.5, .1, R, 40), t(.2, .25, R, 10), t(.8, .25, R, 10),

...
(function (KS) {
  ...
  const LIST = [
    ...
    { par: 45, ai: [R], range: .5, intro: 'rocks', towers: [   // 12: kayalar
    ...
    { par: 120, ai: [R, Y], range: .42, persona: { 3: 'aggressive' }, tip: 'İkisi de saldırgan!', towers: [   // 19: nehir + kayalar + iki rakip
